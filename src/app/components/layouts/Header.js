...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed z-50 inset-x-0 top-0 border-b border-zinc-700 bg-black">
          ...
          <div className="md:mx-24 mx-8 flex justify-between items-center py-4 px-4">
              ...
              <ul id="navbar" className={`${navbar ? 'bg-black/75 backdrop-blur-sm px-12 py-4 flex flex-col gap-y-2 absolute inset-x-0 top-14 border-b border-zinc-700 z-50' : 'hidden md:flex items-center gap-4'}`}>
